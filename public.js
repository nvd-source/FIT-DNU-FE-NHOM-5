        ...
        col.innerHTML = `
            <div class="card h-100 shadow-sm public-drink-card">
                ...
                <div class="public-drink-image-wrapper">
                    ...
                    <img 
                        src="${drink.imageUrl || 'https://via.placeholder.com/300x200'}" 
                        class="card-img-top public-drink-image" 
                        alt="${drink.name}"
                    >
                    ...
                    <div class="mt-auto">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button 
                                ...
                                onclick="addDrinkToOrder('${drink.id}', '${drink.name}')"
                            >
...
function loadSavedReservationData() {
    ...
    if (document.getElementById('reservationTime')) {
...
function addDrinkToOrder(drinkId, drinkName) {
    ...
    showToast(
        `Đã thêm ${drinkName} vào đơn hàng`,
        'success'
    );
}
